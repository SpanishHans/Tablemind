...
export default function PromptPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Aquí puedes agregar la lógica para procesar el prompt
    // Redirigimos a la página de selección de modelo
    if (promptText.trim()) {
      window.location.href = "/model-select";
    }
  };
        ...
        <div className="max-w-3xl mx-auto py-8">
          ...
          >
            <form onSubmit={handleSubmit}>
              <div className="mb-6">
                <textarea
                  className="w-full bg-gray-700 text-white border border-gray-600 rounded-lg p-4 min-h-[200px] focus:outline-none focus:ring-2 focus:ring-blue-500 resize-y"
